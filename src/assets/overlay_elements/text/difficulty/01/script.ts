...
export class Script
{
    ...
    public AddElement(element: HTMLDivElement): void
    {
        ...
        {
            container: element,
            text: Main.ThrowIfNullOrUndefined(element.querySelector(`.text.difficulty._01 > .difficulty`))
        };
    }
    ...
    public ResetData(): void
    {
        ...
        {
            this.elements[key].text.innerText = "Difficulty";
        }
    }
    ...
    public UpdateMapData(data: MapData): void
    {
        for (const key of Object.keys(this.elements))
        {
            ...
            element.text.innerText = data.Difficulty !== null ? data.Difficulty : "";
        }
    }
