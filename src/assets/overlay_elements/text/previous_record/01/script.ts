...
export class Script
{
    ...
    public AddElement(element: HTMLDivElement): void
    {
        ...
        {
            container: element,
            previousRecord: Main.ThrowIfNullOrUndefined(element.querySelector(`.text.previous_record._01 > .previousRecord`))
        };
    }
    ...
    public UpdateStyles(element: HTMLDivElement, styles: TCustomStyles): void
    {
        ...
        {
            this.elements[element.id].previousRecord.style.fontSize = `${styles.fontSize}px`;
        }
        else
        {
            this.elements[element.id].previousRecord.style.removeProperty("fontSize");
        }
    }
    ...
    public UpdateMapData(data: MapData): void
    {
        for (const key of Object.keys(this.elements))
        {
            ...
            element.previousRecord.innerText = UI.SeperateNumber(data.PreviousRecord);
        }
    }
...
type Elements =
{
    [id: string]:
    {
        ...
        previousRecord: HTMLParagraphElement
    }
}