...
export class Script
{
    ...
    public AddElement(element: HTMLDivElement): void
    {
        ...
        {
            container: element,
            text: Main.ThrowIfNullOrUndefined(element.querySelector(`.text.song_name._01 > .songName`))
        };
    }
    ...
    public ResetData(): void
    {
        ...
        {
            this.elements[key].text.innerText = "Song Name";
        }
    }
    ...
    public UpdateMapData(data: MapData): void
    {
        for (const key of Object.keys(this.elements))
        {
            ...
            element.text.innerText = data.SongName !== null ? data.SongName : "";
        }
    }
