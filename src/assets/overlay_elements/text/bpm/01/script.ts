...
export class Script
{
    ...
    public AddElement(element: HTMLDivElement): void
    {
        ...
        {
            container: element,
            text: Main.ThrowIfNullOrUndefined(element.querySelector(`.text.bpm._01 > .bpm`))
        };
    }
    ...
    public ResetData(): void
    {
        ...
        {
            this.elements[key].text.innerText = "BPM";
        }
    }
    ...
    public UpdateMapData(data: MapData): void
    {
        for (const key of Object.keys(this.elements))
        {
            ...
            element.text.innerText = UI.SeperateNumber(data.BPM);
        }
    }
