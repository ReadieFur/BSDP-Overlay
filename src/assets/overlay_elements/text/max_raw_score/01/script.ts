...
export class Script
{
    ...
    public AddElement(element: HTMLDivElement): void
    {
        ...
        {
            container: element,
            text: Main.ThrowIfNullOrUndefined(element.querySelector(`.text.max_raw_score._01 > .maxRawScore`))
        };
    }
    ...
    public ResetData(): void
    {
        ...
        {
            this.elements[key].text.innerText = "Max Raw Score";
        }
    }
    ...
    public UpdateLiveData(data: LiveData): void
    {
        for (const key of Object.keys(this.elements))
        {
            ...
            element.text.innerText = UI.SeperateNumber(data.MaxScore);
        }
    }
}
