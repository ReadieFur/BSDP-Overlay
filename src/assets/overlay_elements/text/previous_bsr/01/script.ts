...
export class Script
{
    ...
    public AddElement(element: HTMLDivElement): void
    {
        ...
        {
            container: element,
            previousBSR: Main.ThrowIfNullOrUndefined(element.querySelector(`.text.previous_bsr._01 > .previousBSR`))
        };
    }
    ...
    public UpdateStyles(element: HTMLDivElement, styles: TCustomStyles): void
    {
        ...
        {
            this.elements[element.id].previousBSR.style.fontSize = `${styles.fontSize}px`;
        }
        else
        {
            this.elements[element.id].previousBSR.style.removeProperty("fontSize");
        }
    }
    ...
    public UpdateMapData(data: MapData): void
    {
        for (const key of Object.keys(this.elements))
        {
            ...
            element.previousBSR.innerText = data.PreviousBSR !== null ? data.PreviousBSR : "";
        }
    }
...
type Elements =
{
    [id: string]:
    {
        ...
        previousBSR: HTMLParagraphElement
    }
}