...
export class Script
{
    ...
    public AddElement(element: HTMLDivElement): void
    {
        ...
        {
            container: element,
            element: Main.ThrowIfNullOrUndefined(element.querySelector(`.bar.health._01`)),
            background: Main.ThrowIfNullOrUndefined(element.querySelector(`.bar.health._01 .background`)),
            track: Main.ThrowIfNullOrUndefined(element.querySelector(`.bar.health._01 .track`)),
            bar: Main.ThrowIfNullOrUndefined(element.querySelector(`.bar.health._01 .bar`)),
    ...
    public UpdateLiveData(data: LiveData): void
    {
        for (const key of Object.keys(this.elements))
        {
            this.elements[key].progress = data.PlayerHealth;
            this.UpdateProgress(key);
        }
    }
