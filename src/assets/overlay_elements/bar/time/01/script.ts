...
export class Script
{
    ...
    public AddElement(element: HTMLDivElement): void
    {
        ...
        {
            container: element,
            element: Main.ThrowIfNullOrUndefined(element.querySelector(`.bar.time._01`)),
            background: Main.ThrowIfNullOrUndefined(element.querySelector(`.bar.time._01 .background`)),
            track: Main.ThrowIfNullOrUndefined(element.querySelector(`.bar.time._01 .track`)),
            bar: Main.ThrowIfNullOrUndefined(element.querySelector(`.bar.time._01 .bar`)),
    ...
    public UpdateLiveData(data: LiveData): void
    {
        ...
        {
            this.elements[key].progress = this.MapLength !== undefined ? data.TimeElapsed / this.MapLength * 100 : 0;
